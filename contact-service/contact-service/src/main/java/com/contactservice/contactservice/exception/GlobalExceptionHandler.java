...
public class GlobalExceptionHandler {
    ...
    @ExceptionHandler(ContactQueryNotFoundException.class)
    public ResponseEntity<APIErrorResponse> handleNotFound(
            ContactQueryNotFoundException ex, HttpServletRequest request
    ) {
        return ResponseEntity.status(HttpStatus.NOT_FOUND).body(buildError(
                HttpStatus.NOT_FOUND, "Contact Query Not Found", ex.getMessage(), request.getRequestURI()
        ));
    }
